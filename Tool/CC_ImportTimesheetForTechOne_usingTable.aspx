<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CC_ImportTimesheetForTechOne_usingTable.aspx.cs" Inherits="Web_DepartmentManage" MasterPageFile="~/Tool/MasterPage.master" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="height: 825px; width: 101%">
        ...
        <tr>
            ...
            <td valign="top" align="left">
                ...
                <strong><span style="font-size: large; color: #0000FF">Load ComCare Timesheet file and Process for TechOne using Mapping table --</span><span style="font-size: large; color: #FF0000">Testing</span><span style="font-size: large; color: #0000FF"><br />
