...
public partial class Web_DepartmentManage : System.Web.UI.Page
{
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        else
        {
           ...
           // TextBox3.Text = "";
            ...
            SqlCommand Cmd = new SqlCommand("P_ComCare_Timesheet_ForT1_AutoPay", connsql);
           ...
           // Cmd.Parameters.Add("@P_EndDay", SqlDbType.VarChar, 10).Value = "2015-08-16".ToString();
            try
            {
                ...
                SqlCommand Cmdall = new SqlCommand("select count(*) from CC_T1_Timesheet_ReadforExport_withno_AP", connsqlall);
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
       ...
       // TextBox3.Text = TextBox3.Text + Filenumber.ToString();
        ...
        string fileserverfolderProcessed = ConfigurationManager.AppSettings["CCToT1ManyfilesProcessed"].ToString();
        ...
        FileInfo[] Files = d.GetFiles("ComCareToT1CIAnywhereAutopay*.csv");
        //string str = "";
        foreach (FileInfo file in Files)
        {
            file.CopyTo(fileserverfolderProcessed + DateTime.Now.ToString("yyyyMMddHHmmss") + file.Name);
            file.Delete();
        }
        TextBox3.Text = TextBox3.Text + logtime + " -----All old files have been moved to " + fileserverfolderProcessed + "-----\r\n";
        ...
        {
            String exportfilename = "ComCareToT1CIAnywhereAutopay" + i.ToString() + ".csv";
    ...
    protected void SSISExport(string filename, int startno, int endno)
    {
        ...
        // Instantiate SSIS application object
        Microsoft.SqlServer.Dts.Runtime.Application myApplication = new Microsoft.SqlServer.Dts.Runtime.Application();
        string fileName3 = Path.Combine(Server.MapPath("~/Upload"), "ComCareTimesheetToT1Cianywhere_autopay.dtsx");
        // TextBox3.Text = TextBox3.Text+logtime + "Loading import package from file system...\r\n";
        Package myPackage = myApplication.LoadPackage(@fileName3, null);
        ...
        protected void Button9_Click(object sender, EventArgs e)
        {
            ...
            TextBox3.Text = TextBox3.Text + logtime + " Start to export timesheet for Techone CiAnywhere...\r\n";
            //invoke ssis package to export
            string fileserverfolder = ConfigurationManager.AppSettings["ComCareToT1CiAnwhereAutopay"].ToString();
            // Instantiate SSIS application object
            Microsoft.SqlServer.Dts.Runtime.Application myApplication = new Microsoft.SqlServer.Dts.Runtime.Application();
            string fileName3 = Path.Combine(Server.MapPath("~/Upload"), "CCToT1AutoPay.dtsx");
            // TextBox3.Text = TextBox3.Text+logtime + "Loading import package from file system...\r\n";
            Package myPackage = myApplication.LoadPackage(@fileName3, null);
            myPackage.Variables["filefolder"].Value = fileserverfolder;
            ...
            if (myResult.ToString()== "Failure")
            {
                string err = "";
                foreach (Microsoft.SqlServer.Dts.Runtime.DtsError local_DtsError in myPackage.Errors)
                {
                    string error2 = local_DtsError.Description.ToString();
                    err = err + error2;
                }
                TextBox3.Text = TextBox3.Text + logtime + "Error details are: "+err+".\r\n";
