<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CCToT1_ImportTimesheet.aspx.cs" Inherits="Web_DepartmentManage" MasterPageFile="~/Tool/MasterPage.master" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="height: 825px; width: 101%">
        ...
        <tr>
            ...
            <td valign="top" align="left">
                ...
                <strong><span style="font-size: large; color: #0000FF">Load ComCare Timesheet file and Process for Technology One payroll<br />
                </span><span style="font-size: small; color: #0000FF">-- Please generate timesheet file using ComCare front end before loading --<br />
                </span><span style="font-size: xx-large; color: #CC0000">--
                Still developing and testing --</span><span style="font-size: small; "><br style="color: #FF0000" />
                </span></strong><br style="font-size: large; color: #FF0000; font-weight: 700" />
                ...
                <asp:Panel ID="Panel1" runat="server" Height="447px" Width="1260px">
                    ...
                    <br />
                    <br />
                    <span style="color: #FF0000"><i>Reports:&nbsp;&nbsp; &nbsp;<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="http://10.100.0.141:90/ASAReportServer/CC_TimesheetToCIM.aspx" Target="_Blank">XX</asp:HyperLink>
