...
public partial class Web_DepartmentManage : System.Web.UI.Page
{
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        string stagesql2 = "insert into CC_T1_Timesheetfile_import_stage select * from CC_T1_Timesheetfile_import where payperiod='"+payperiod+"';";
        ...
        string stagesql3 = "update t1 set t1.[Payroll Number]=t2.employee_no from CC_T1_Timesheetfile_import_stage as t1 inner join [appsql-3\\comcareprod].comcareprod.dbo.provider as t2 on t1.[Provider ID]=t2.provider_id where len(t1.[Payroll Number])<=1 and t2.employee_no is not null";
        ...
        SqlCommand Cmd3 = new SqlCommand(stagesql3, connsql3);
        ...
        {
            TextBox3.Text = TextBox3.Text + logtime + "update employeeID for table CC_T1_Timesheetfile_import_stage fail: " + ex.Message;
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
       ...
       // TextBox3.Text = TextBox3.Text + Filenumber.ToString();
        ...
        foreach (FileInfo file in Files)
        {
           // file.CopyTo(fileserverfolderProcessed+DateTime.Now.ToString("yyyy-mm-dd h:mm:ss tt")+file.Name);
