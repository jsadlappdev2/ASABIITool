<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CCT1_MaintainPaiPeriod.aspx.cs" Inherits="Web_UserManage"  MasterPageFile="~/Tool/MasterPage.master" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
          ...
          <tr>
            ...
            <td  valign="top" align="left" width="960px" colspan="2">
                ...
                <span style="font-size: medium; color: #003366"><strong>&nbsp;====Maintain pay period==== </strong></span>&nbsp;<div class="BoxSearchBar">           
                                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:TemplateField>
                     ...
                     <asp:TemplateField HeaderText="Pno">                           
                      ...
                      <asp:TemplateField HeaderText="StartDay">
                            <EditItemTemplate>
                                <asp:TextBox ID="StartDay" Width="300px" Height="80px" runat="server" Text='<%# Eval("StartDay") %>' TextMode="MultiLine"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                      ...
                      <asp:TemplateField HeaderText="EndDay">
                          ...
                          <asp:TemplateField HeaderText="Note">
                            <EditItemTemplate>
                                <asp:TextBox ID="Note" Width="100px" runat="server" Text='<%# Eval("Note") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                 ...
                 <asp:Label ID="LabelPageInfo" runat="server"></asp:Label>
                          ...
                          <div class="BoxToolBar" style="color: #0000FF; width: 1066px;">
                              <strong><span style="color: #003366; font-size: large">====Add new pay period====&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong>
          ...
          <tr>
            ...
            <td  valign="top" align="left">
                          ...
                          <b style="color: #003366">StartDay:</b></td>
   
            <td  valign="top" align="left" width="960px" style="width: 480px; ">
           
                          <asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="White" BorderWidth="1px" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" Height="103px" NextPrevFormat="FullMonth" Width="353px">
          ...
          <tr>
            ...
            <td  valign="top" align="left" width="960px" style="width: 480px">
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Add new pay period" Width="178px" OnClick="Button1_Click" style="font-weight: 700; color: #003366" />
            </td>
        </tr>
