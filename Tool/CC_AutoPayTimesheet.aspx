<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CC_AutoPayTimesheet.aspx.cs" Inherits="Web_DepartmentManage" MasterPageFile="~/Tool/MasterPage.master" %>
...
<table border="0" cellpadding="0" cellspacing="0" style="height: 825px; width: 101%">
        ...
        <tr>
            ...
            <td valign="top" align="left">
                ...
                <strong><span style="font-size: large; color: #0000FF">ComCare Autopay Provider Timesheet data Process<br />
                </span><span style="font-size: small; color: #0000FF">-- Please make sure that the AutoPay providers' timesheets have been authorised in ComCare--<br />
                </span><span style="font-size: small; color: #0000FF">-- Data directly comes from ComCare database Activity_work_table--<br />
                ...
                <asp:Panel ID="Panel1" runat="server" Height="447px" Width="1260px">
                    ...
                    <br />
                    <br />
                    <span style="color: #FF0000"><i>Reports:&nbsp;&nbsp; &nbsp;<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="http://10.10.1.186:90/ASAReportServer/CC_AutopayTimsheet.aspx" Target="_Blank">Report_AutopayTimesheet</asp:HyperLink>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</i></span></b><asp:Panel ID="Panel2" runat="server" Height="251px" Width="730px" style="text-decoration: underline">
                        <br />
                        <asp:Label ID="Label8" runat="server" Text="Autopay Timesheet import and process logs:"></asp:Label>
                        &nbsp;&nbsp;
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ASADWHConnectionString %>" SelectCommand="SELECT [Lno], [PR_StartDay], [PR_EndDay], [DP_Log], [InsertTime] FROM [CC_Mileage_Autopay_DataProcess_Log] ORDER BY [Lno], [InsertTime]"></asp:SqlDataSource>
                        <br />
                    </asp:Panel>
