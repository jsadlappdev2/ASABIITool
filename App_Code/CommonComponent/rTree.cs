...
namespace OnLineExam.CommonComponent
{
    ...
    public class Tree2
    {
        ...
        public string CreateTree2(DataTable dataTable)
        {
            ...
            DataTable childNodes = GetChilds2(0);	//获取根节点的所有孩子
            ...
            foreach (DataRow dr in childNodes.Rows)
            {
                ...
                sMenu += CreateSubTree2(childId);//递归
            }
        ...
        private int GetLevel2(int nodeId)
        {
            ...
            if (parentId == 0) return 1;
                ...
                return GetLevel2(parentId) + 1;	//递归
        }
        ...
        {
            string sMenu = "";
            DataTable childNodes = this.GetChilds2(nodeId);	//获取根节点的所有孩子
